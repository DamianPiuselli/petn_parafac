...
def download_tauler_b():
    url = "http://www.cid.csic.es/homes/rtaqam/tmp/WEB_MCR/download/datasets/bdataset.zip"
    dest_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../data/chroma/tauler_b"))
    os.makedirs(dest_dir, exist_ok=True)
    zip_path = os.path.join(dest_dir, "bdataset.zip")

    print(f"Downloading Real HPLC-DAD data set (B) from CSIC...")
    try:
