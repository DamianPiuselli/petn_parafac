...
|---|---|---|---|---|
| **Component 1** | Component 1 (Baseline Interference) | 0.999303 | 0.990341 | 0.999963 |
| **Component 2** | Component 2 (Peak 1) | 0.999438 | 0.990545 | 0.999961 |
| **Component 3** | Component 3 (Peak 2) | 0.999295 | 0.990496 | 0.999951 |

### Key Averages:
- **Mean Score Similarity:** 0.999345
- **Mean Elution Profile Similarity:** 0.990460
- **Mean Spectral Profile Similarity:** 0.999958
...
- **Mean Coordinate Alignment Error (MAE):** 2.527225e-03 (normalized time units)
- **Shift Parameter (beta) Correlation:** 0.988754
- **Stretch Parameter (alpha) Correlation:** 0.992005
- **Mean Absolute Shift Parameter Error:** 3.504646e-03
